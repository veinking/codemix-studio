        ...
        <div className="flex h-full w-[340px] flex-col">
          ...
          <Tabs defaultValue="data" className="flex min-h-0 flex-1 flex-col">
            <TabsList className="h-11 w-full justify-start gap-1 rounded-none border-b bg-background px-3">
              <TabsTrigger value="data" className="h-8 gap-1.5 px-3 text-xs"><Database className="h-3.5 w-3.5" /> Data</TabsTrigger>
              <TabsTrigger value="packages" className="h-8 gap-1.5 px-3 text-xs"><Package className="h-3.5 w-3.5" /> Packages</TabsTrigger>
              <TabsTrigger value="assist" className="h-8 gap-1.5 px-3 text-xs"><KeyRound className="h-3.5 w-3.5" /> Assist</TabsTrigger>
            </TabsList>
