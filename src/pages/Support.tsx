    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Email us at support@pocketbi.app for technical support, billing questions, or general inquiries. We're here to help you get the most out of bIDE."
        }
      },
      {
        "@type": "Question",
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-muted rounded-lg">
                ...
                <a 
                  href="mailto:support@pocketbi.app"
