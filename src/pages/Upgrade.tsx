      ...
      <div className="container max-w-6xl py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            bIDE uses your shared PocketBI capabilities instead of maintaining a separate subscription system.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                ...
                <Feature>Local-first code workspace</Feature>
                <Feature>Supported browser runtimes</Feature>
                <Feature>No account required to start</Feature>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                ...
                <Feature>Free-tier cloud/AI allowance when available</Feature>
                <Feature>Account-backed features as they are enabled</Feature>
              </ul>
              {isGuest && (
          ...
          <Card className="border-2 border-primary relative">
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                ...
                <Feature>Higher metered compute allowance when enabled</Feature>
                <Feature>Access that can span supported PocketBI tools</Feature>
              </ul>
              {isPro ? (
                ...
                <Alert className="mt-4">
                  ...
                  <AlertTitle>Pricing is being finalized at the PocketBI level</AlertTitle>
                  <AlertDescription>
                    bIDE intentionally does not open a separate checkout. This prevents duplicate billing while PocketBI plans and product flows are finalized.
                  </AlertDescription>
                </Alert>
              )}
            </CardContent>
