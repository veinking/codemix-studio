...
export default function CSharpDocs() {
  ...
  return (
    <>
      ...
      <SoftwareApplicationSchema 
        language="csharp"
        languageName="C#"
        description="Free online C# code editor. Learn C# for .NET development, Unity game development, and Windows applications. Modern OOP language."
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-slate-50 to-purple-50 dark:from-background dark:via-slate-900 dark:to-purple-950">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Microsoft's modern OOP language</p>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <Button size="sm" onClick={() => navigate('/ide?lang=csharp')}>
                  Open in IDE
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    C# is Microsoft's modern, object-oriented language for building Windows applications, web services, 
                    and games with Unity. It combines power with developer productivity.
                  </p>
                  <div>
          ...
          <div className="mt-12 pt-8 border-t border-border flex justify-between">
            ...
            <Button onClick={() => navigate('/ide?lang=csharp')}>
              Open in IDE
            </Button>
          </div>
        </div>
