...
export const SEO_CONFIGS = {
  ...
  docs: {
    ...
    canonical: 'https://codemixapp.com/docs'
  },
  pythonDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/python'
  },
  rDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/r'
  },
  javascriptDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/javascript'
  },
  sqlDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/sql'
  },
  phpDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/php'
  },
  rubyDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/ruby'
  },
  luaDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/lua'
  },
  javaDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/java'
  },
  typescriptDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/typescript'
  },
  cppDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/cpp'
  },
  cDocs: {
    title: 'C Documentation - bIDE | C Programming Reference',
    ...
    canonical: 'https://codemixapp.com/docs/c'
  },
  rustDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/rust'
  },
  goDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/go'
  },
  swiftDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/swift'
  },
  kotlinDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/kotlin'
  },
  csharpDocs: {
    ...
    canonical: 'https://codemixapp.com/docs/csharp'
  },
  auth: {
