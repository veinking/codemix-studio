...
assert.ok(!allNativeSource.includes("import Supabase"), "Phase 2 scope leak detected: import Supabase");
...
assert.deepEqual(
  ...
  "StoreKit must stay isolated from the audited SQL/data surface."
);
