...
const files = [
  ...
  "ios/BideTests/CurrentGenerationValueDriftTests.swift",
  "ios/BideTests/Build12CorruptExportRegressionTests.swift",
...
requireTokens("ios/BideApp/Stores/DataWorkspaceStore+DatabaseMigration.swift", [
  ...
  "DatasetValueFingerprint",
  "canonicalSourceFingerprint",
  "actualRowCount == table.rowCount",
  "actualFingerprint.value == expectedFingerprint",
  "table schemas, row counts, or values still do not match",
]);
...
const exportStore = requireTokens("ios/BideApp/Stores/DataWorkspaceStore+SQLExport.swift", [
  ...
  "serializedTables",
  "DatasetParser.parse(url: outputURL, format: .csv)",
...
const regressions = [
  ...
  ["ios/BideTests/CurrentGenerationValueDriftTests.swift", "testCurrentGenerationSameShapeValueDriftIsRebuiltBeforeJoinAndExport"],
  ["ios/BideTests/Build12CorruptExportRegressionTests.swift", "testBuild12HardwareArtifactIsRejectedInsteadOfReinterpretedAsOneDataset"],
