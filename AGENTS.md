...
- Preserve the native editor/project shell and current Phase-2 local Dataset/SQLite design.
- Do not expand scope into PocketBI cloud/auth/billing, remote databases, or R/Python runtime work unless the active phase explicitly calls for it.
